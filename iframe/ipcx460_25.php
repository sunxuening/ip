	...
	<body style="margin:0px;">
		<center>
			<table border='0' width='600' cellspacing='1' bgcolor='#cccccc'><tbody>
				<tr>
					<td align=center width='16%' bgcolor='#eeeeee'>您的IP是：</td>
					<td bgcolor='#FFFFFF' width='20%'>&nbsp;<a target="_blank" href="http://ip.liangwei.cc/ip.php?ipdz=<?php echo $clientip ?>" title="ip地理位置详细查询"><?php echo $clientip ?> 
					</td>
					<td align=center width='12%' bgcolor='#eeeeee'>来自：</td>
					<td bgcolor='#FFFFFF' width='52%'>&nbsp;<a target="_blank" href="http://ip.liangwei.cc/" title="本信息来自ip.liangwei.cc"><?php echo "$czipxx"  ?> 
					</td>
				</tr>
			</table>
		</center>
